...
export class LandingComponent {
  commonGutHealthStruggles = [
    ...
    },
    {
      ...
      description: 'Mood swings hit without warning, leaving you irritable or low.',
    },
    {
      ...
      description: 'Brain fog makes it hard to focus or think clearly.',
    },
    {
